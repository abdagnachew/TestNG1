...
public class CommonMethods extends BaseClass {
	...
	/**
	 * Method that selects value by valueAttribute
	 * 
	 * @param element
	 * @param valueAttribute
	 */
	
	public static void selectDdValuebyValue(WebElement element, String valueAttribute) {
		try {
			Select select=new Select(element) ;
				List<WebElement> options= select.getOptions();
				
				for(WebElement o:options) {
					if(o.getText().equals(valueAttribute)) {
